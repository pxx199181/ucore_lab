...
alloc_proc(void) {
	 ...
	 */
     //LAB6 P14226010 : (update LAB5 steps)
    /*
     ...
     */
    //LAB8:EXERCISE2 P14226010 HINT:need add some code to init fs in proc_struct, ...
        proc->wait_state = 0;
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    //LAB8:EXERCISE2 P14226010  HINT:how to copy the fs in parent's proc_struct?
    /*
    ...
    //char name[20];
    //snprintf(name, 20, "me(id = %d)", proc->pid);
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 P14226010  HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
    ...
    struct proghdr ph_buff, *ph = &ph_buff;
